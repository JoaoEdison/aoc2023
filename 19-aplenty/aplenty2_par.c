...
// Go to nine seconds, it means a speedup of 3.33.
...
short *intervals;
{
    ...
    total = 0;
    #pragma omp parallel shared(total, end, intervals,\
            bounds_uniq_sorted, end_bounds_uniq_sorted)\
            private(i, j, k, l, m, \
            x1, x2, dx, y1, y2, dy, z1, z2, dz, w1, w2, dw,\
            stack_x, stack_y, stack_z)
    { 
